...
number_of_licenses <- length(number_of_licenses[3]$result)
...
# Adding pretty names.
names(hdx_repo_analytics) <- c("Number_of_Datasets", "Number_of_Countries", "Number_of_Organizations", "Number_of_Users", "Number_of_Tags", "Number_of_Licenses", "Data_and_Time")
